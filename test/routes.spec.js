...
describe("API Routes", function() {
  ...
  describe("PUT /api/v1/shows/:id", function() {
    ...
    it("should NOT update a show if the id field is part of the request", function(
      done
    ) {
      chai
        .request(server)
    ...
    it("should delete a show", function(done) {
      chai
        ...
        .end(function(err, res) {
          ...
          res.body.should.have.property("explicit");
          res.body.explicit.should.equal(false);
          // ** MARK ** The code below is checking the new item at position [0]. It should be the next object in the array of movies.
          chai
            .request(server)
            .get("/api/v1/shows")
            .end(function(err, res) {
